...
function PasVideRepertoire(form)
{
	...
	if(Prts == 0)
	{
		alert(<? echo $strFileRepAlertChamps; ?>);
		erreur = false;
	}
	else erreur = true;
	return erreur;
...
<TD><table border=1 width=100% bgcolor="#D6D3CE" cellspacing=0 cellpadding=1><tr><td><? echo $strCreerRepFileN; ?><? echo $Directory; ?></td></tr></table></TD>
</TR></TABLE><BR>
<table cellspacing=20><tr><td>
<FORM  ACTION="./index.php" METHOD="POST">
<? echo $strCreerRepNomRepFileN ?><BR>
